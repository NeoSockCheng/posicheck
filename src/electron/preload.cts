...
electron.contextBridge.exposeInMainWorld('electron', {
  ...
  // Feedback methods
  getAllFeedback: (options: { limit?: number; offset?: number }) => 
    ipcInvoke('getAllFeedback', options),
  getFeedbackById: (id: number) => 
    ipcInvoke('getFeedbackById', { id }),
  getFeedbackImage: (params: { imagePath: string; quality?: number; maxWidth?: number }) => 
    ipcInvoke('getFeedbackImage', params),
  exportFeedback: () => 
    ipcInvoke('exportFeedback', {}),
